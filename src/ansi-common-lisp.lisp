...
;; [[file:ansi-common-lisp.org::*Compress][Compress:1]]
(defun compress (x)                                             ; (7)
  (if (consp x)
...
;; [[file:ansi-common-lisp.org::*Decompress][Decompress:1]]
...
;; [[file:ansi-common-lisp.org::*Decompress][Decompress:2]]
    (append (expand-items (car rest)
                        (second rest))
            rest)
;; Decompress:2 ends here

;; [[file:ansi-common-lisp.org::*Both combined][Both combined:1]]
