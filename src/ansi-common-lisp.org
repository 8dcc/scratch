...
** Exercises
*** Exercise 1
_Describe what happens when the following expressions are evaluated._
...
*** Exercise 2
_Give three distinct =cons= expressions that return =(a b c)=._
...
*** Exercise 3
_Using =car= and =cdr=, define a function to return the fourth element of a list._
...
*** Exercise 4
_Define a function that takes two arguments and returns the greater of the two._
